...
from course_app.configDatabase import MONGO_DB, MONGO_COURSES_COLLECTION as db_courses, MONGO_OPEN_COURSES_COLLECTION as db_open_courses, MONGO_USERS_COLLECTION as db_users
from course_app.configDatabase import MONGO_MAJOR_COLLECTION as db_prodi
