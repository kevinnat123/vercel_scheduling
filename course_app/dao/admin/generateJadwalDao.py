...
from course_app.database import MONGO_DB, MONGO_LECTURERS_COLLECTION as db_dosen, MONGO_OPEN_COURSES_COLLECTION as db_matkul_simpanan, MONGO_CLASSES_COLLECTION as db_kelas
from course_app.database import MONGO_SCHEDULE_COLLECTION as db_jadwal
