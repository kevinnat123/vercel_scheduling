...
from course_app.config import MONGO_DB, MONGO_MAJOR_COLLECTION as db_prodi, MONGO_USERS_COLLECTION as db_user
from course_app.config import MONGO_LECTURERS_COLLECTION as db_dosen
