...
from mongoConfig import MONGO_DB, MONGO_MAJOR_COLLECTION as db_prodi, MONGO_USERS_COLLECTION as db_user
from mongoConfig import MONGO_LECTURERS_COLLECTION as db_dosen
