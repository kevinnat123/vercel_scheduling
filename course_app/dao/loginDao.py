...
from course_app.configDatabase import MONGO_DB, MONGO_USERS_COLLECTION as db_users, MONGO_URLS_COLLECTION as db_urls, MONGO_MAJOR_COLLECTION as db_prodi
...
class loginDao:
    ...
    def signUp(self, u_id, role, password):
        print(f"{'[ DAO ]':<25} Sign Up Usser: {u_id}")
